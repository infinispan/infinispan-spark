...
public class StreamProducerJava {
   ...
   public static void main(String[] args) {
      if (args.length < 5) {
         System.out.println("Usage: StreamProducerJava <twitter4j.oauth.consumerKey> <twitter4j.oauth.consumerSecret> <twitter4j.oauth.accessToken> <twitter4j.oauth.accessTokenSecret> <infinispan_host>");
         System.exit(1);
      }
